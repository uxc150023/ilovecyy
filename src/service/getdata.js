...
let postUrl = {
    ...
    WEBSITEACLACES: 'learn/StuNSite/WebSiteAcLACES', //抢注网名网址接口
    ...
    SSTNETPRTYPE: 'learn/NetPrType/SSTNetPrType', //查询建站价格和类型
    ...
    SAVEMENU: 'learn/stuorg/saveMenu', //根据栏目主键更新栏目配置接口
    ...
    // DOWNLOAD_LEADEREXCEL: 'learn/stumem/downloadForLead', //下载学会领导Excel导入模版
    // DOWNLOAD_MEMBEREXCEL: 'learn/stumem/downloadForMem',  //下载学会会员Excel导入模版接口
    ...
    MFOLLOWINFO: 'learn/mfollow/info', //住宿一览
    ...
    PUBSET_GETCNT: 'learn/pubset/getCnt', //理事会内容查询，0	新学界是何界1会员/理事权利 2会员/理事条件

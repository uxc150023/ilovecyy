<template>
    <div class="setting_dialog">
        <el-form ref="form"
            ...
            <p class="text-right">背景图推荐尺寸1020X370,JPG/GIF/PNG,500K以内<el-button type="text"
                           @click="uploadBg()">浏览/上传</el-button>
            </p>
            ...
            <div class="setting_a">
                ...
                <el-row>
                    <el-col :span="4"
                            v-for='(elem, index) in navlist'
                            :key='index'>
                        <el-checkbox v-if='elem.isDelete != 1 && elem.isVisible === 1'
                                     v-model='checked'>{{elem.name}}</el-checkbox>
            ...
            <div class="setting_b">
                ...
                <el-row>
                    <el-col :span="3"
                            v-for='(elem, index) in navlist'
                            :key='index'>
                        <el-button v-if='elem.isDelete != 1'
                                   type="text"
                                   @click='compilebg(elem.bid, elem.name)'>{{elem.name}}</el-button>
                    </el-col>
                </el-row>
            </div>
            <el-form-item class="btnBox text-right">
                <el-button type="primary"
                           @click="onSubmit">确&emsp;&emsp;定</el-button>
            </el-form-item>
        </el-form>
        ...
        <app-modal :modalInfo='modalInfo1'
                   v-on:modalClosed='modalaClosed'>
            <div class="setting_content">

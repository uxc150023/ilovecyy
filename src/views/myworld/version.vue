    ...
    <div id="version">
        <div class="content">
            <app-tabmeeting v-bind:id="id" v-bind:tabItem="tabOne" v-on:change="change">
                ...
                <app-listTwo v-if="myProduction" v-bind:dataList="dataList">
                </app-listTwo>
                ...
                <div v-if="myHouse" class="panelTwo">
                    ...
                    <div class="mainContent" ref="myResume"></div>
        ...
        methods: {
            ...
            getPerResume () {
                _getData(_getUrl('MSEPRODETAIL'),{
                    ...
                    if (res.code === 200) {
                        this.perResume = res.data;
                        // this.mainText.content = res.data.intro;
                        this.$refs.myResume.innerHTML = JSON.parse(res.data.intro).main;
                    }
                });
            },
            //编辑我的家门
